...
class TestRustProjectSetup:
    ...
    def test_creates_project_structure(self, simple_context):
        from alchemize.pytorch_rust_transpiler import _setup_rust_project
...
class TestTranspilerTools:
    ...
    def test_read_source(self, agent_state):
        from alchemize.pytorch_rust_transpiler import _tool_read_source
    ...
    def test_cargo_build_placeholder(self, agent_state):
        ...
        from alchemize.pytorch_rust_transpiler import _tool_cargo_build
    ...
    def test_validate_no_binary(self, agent_state):
        ...
        from alchemize.pytorch_rust_transpiler import _tool_validate
...
class TestSkills:
    ...
    def test_pytorch_to_rust_skill_exists(self):
        from alchemize.pytorch_rust_transpiler import _load_skill
...
class TestRustTranspileResult:
    ...
    def test_success_property(self):
        from alchemize.pytorch_rust_transpiler import RustTranspileResult
...
class TestPromptBuilding:
    ...
    def test_prompt_contains_model_info(self):
        ...
        from alchemize.pytorch_exporter import PytorchModelExporter
        from alchemize.pytorch_rust_transpiler import _build_user_prompt
